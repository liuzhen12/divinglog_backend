...
//            'course_id' => $this->bigInteger(20)->notNull()->defaultValue(0)->comment('关联课程'),
            'organization' => $this->string(45)->notNull()->defaultValue('')->comment('关联课程组织SSI,PADI,NUI,CMAS'),
            'category' => $this->string(45)->notNull()->defaultValue('')->comment('scuba,freediver,snorkeling'),
            'duty' => $this->string(45)->notNull()->defaultValue('')->comment('diver,instructor,specialty,technical'),
            'name' => $this->string(45)->notNull()->defaultValue('')->comment('关联课程名'),
